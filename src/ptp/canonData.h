...
const std::vector<std::pair<uint32_t, CameraPropValue>> CanonApertureValues = {
...
const std::vector<std::pair<uint32_t, CameraPropValue>>
    CanonShutterSpeedValues = {
...
const std::vector<std::pair<uint32_t, CameraPropValue>> CanonISOValues = {
